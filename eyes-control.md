...
2. Отображаемое эмоциональное сотояние.
...
Смена отображаемых эмоций --- более редкое событие, чем изменение направления взгляда.
...
Наиболее спорное решение --- раздельный тракт. Общий тракт будет проще для реализации.

### Открытые вопросы

* Нужна ли поддержка произвольного числа глаз в произвольных местах? 

...
* Возможность выделения отдельного компонента-драйвера зависит сопсоба передачи изображения. Очень желательно для обеспеченеия универсальности
...
* `init(<дерево параметров>)` (или конструктор) --- создание объекта анимации.

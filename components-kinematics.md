...
Для ускорения работы можно предварительно (при конфигурации) выделить зарегестрированные кинематичнские цепочки.

В вспомогательный класс выносится функциональность по загрузке URDF, выделению цепочек, разрешению имен. Он использутся
реализациями кинематики на базе различных библиотек: KDL, RBDL, trac_ik.
...
Возможна ли реализация в виде плагина? 
Видимое препятствие --- нет явного объекта класса, чтобы вызывать его методы.
Текущий вариант --- агрегирования.

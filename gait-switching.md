...
Задатчик может быть в 3-х состояних: активн (operational), активен и запрашивает ресурсы (operational pending), 
...
* **Релизация без приоритетов с возвратом ресурсов прежднему владельцу**
    ...
    * По переходу задатчика в сотояние "не активен" его ресурсы возвращаются прдыдущему владельцу, т.е. фактически происходит обычный раунд распределения, 

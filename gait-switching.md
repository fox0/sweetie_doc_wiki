...
* **pending/operational pending -> operational/nonoperatonal** происходит по получению сообщения `ResourceAssigment` с результатом обработки соответсвующего `ResourceRequest`.

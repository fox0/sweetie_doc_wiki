...
Тот же механизм может быть реализован на база операций. Синхронная природа операций приводит к исключению потери сообщений и гарантированной активации компонента, последним вызвавшем операцию.

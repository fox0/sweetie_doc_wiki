...
2. **Список/таблица контрольных точек**: удаление точки, редактирование времени, редактирования списка значений углов (не особо надо), пометка начальной и конечной точки, флаг "выключения" строки (становится серой, не участвует в формировании траектории).

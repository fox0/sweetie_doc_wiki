...
Компонент обращения приводов [`servo_inv_7param`](components-servo-inv) по желаемым позициям `q`, скоростям `dq` и рассчетным усилиям приводов `tau` определяют команды для приводов, 

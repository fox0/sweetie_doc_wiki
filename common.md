...
Имя фала должно отражать описываемый в нем объект (имя класса, название и назначение библиотеки и т.п.)
Не следует включать в имя файла префиксы, подобные используемым в именах пакетов. 
Например, следует использовать `herkulex_sched.hpp` вместо `sweetie_bot_herkulex_sched.hpp`. 
Файлы уже и так изолированы файловой системой и пакетами.

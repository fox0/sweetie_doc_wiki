...
**Структура каталогов** основного репозитория:
    ...
    rt_control              универсальная часть подсистема управления РВ --- подмодуль git
     ...
     \- config              развертывание OROCOS подсистемы и нероботспецифичные launch файлы.
                
    sweetie_bot             часть системы, специфичная для робота.
     +- rt_control          модули OROCOS предназначенные только для SweetieBot
     |  +- hardware   
     |  +- motion 
     |     \- controllers
     +- hardware            интерфейсные модули оборудования 
     +- sensors             высокоуровневая обработка показания  датчиков (детектирование людей, речи и т.п.)
     +- highlevel           высокоуровневая система принятия решений (flexbe_states)
     |  \- flexbe_behaviors   
     +- actuators           исполнительные органы (sound, eyes, voice)
